...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (tutorButtonParent && tutorMenuParent) {
        ...
        if (window.location.pathname.includes('tutor-applicants-parents') || window.location.pathname.includes('find-tutor-parent') || window.location.pathname.includes('tutor-review')) {
