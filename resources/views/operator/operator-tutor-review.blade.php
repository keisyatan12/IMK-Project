      ...
      <table class="min-w-full bg-white border border-gray-200">
          <thead class="bg-blue-800 rounded-xl">
              <tr class="rounded-md">
                  ...
                  <th class="text-white text-left px-3 py-2 lg:px-6 lg:py-3">Province</th>
          ...
          <tbody>
              <tr class="border-t border-gray-200">
                  ...
                  <td class="px-3 py-2 lg:px-6 lg:py-3 text-left">Jakarta Utara</td>
                  <td class="px-3 py-2 lg:px-6 lg:py-3 text-left">Bad</td>
                  <td class="px-3 py-2 lg:px-6 lg:py-3 text-left"><a href="tutor-review-detail.html" class="underline text-blue-700">See details</a></td>
              </tr>
              <tr class="border-t border-gray-200">
