...
<head>
    ...
    <title>Operator - Tutor Status</title>
</head>
<body>
            ...
            <table class="mt-6 w-full">
              <thead class="bg-blue-800 rounded-xl border border-blue-800">
                <tr class="rounded-md">
                  ...
                  <th class="text-white text-left px-3 py-1 lg:px-10 lg:py-3">ID lowongan</th>
              ...
              <tbody>
                <tr class="border border-yellow-500">
                  ...
                  <td class="lg:px-10 px-3 py-1 lg:py-3 text-left">1</td>
                ...
                <tr class="border border-yellow-500">
                  ...
                  <td class="lg:px-10 px-3 py-1 lg:py-3 text-left">2</td>
                  <td class="lg:px-10 lg:py-3 px-3 py-1 text-left">
                ...
                <tr class="border border-yellow-500">
                  ...
                  <td class="lg:px-10 px-3 py-1 lg:py-3 text-left">3</td>
                  <td class="lg:px-10 lg:py-3 px-3 py-1 text-left">
                    <p class="py-2 px-2 rounded-md text-sm bg-green-300 text-black text-center">On-going</p>
                  </td>
                    <td class="lg:px-10 px-3 py-1 lg:py-3 text-left"><a href="tutor-list-detail.html" class="underline text-blue-700">See details</a></td>
