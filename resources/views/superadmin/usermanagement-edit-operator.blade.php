...
<div class="my-4 w-full mr-10 lg:mr-20 overflow-auto">
    <div class="flex justify-between md:items-end md:flex-row flex-col">
        <div>
            ...
            <p class="text-sm lg:text-base">You can edit operator here</p>

            <h2 class="mt-6 text-lg lg:text-xl font-semibold">Operator Box</h2>
        </div>
    </div>
    <table class="mt-6 w-full">
        ...
        <tbody>
            <tr class="border border-yellow-500">
                ...
                <td class="lg:px-10 px-3 py-1 lg:py-3 text-center">Hired</td>
