<div class="flex my-4 items-start">
    <div class="w-28 md:w-80 sidebar h-auto bg-yellow-200 rounded-xl md:py-8 py-6 px-2 md:px-4 gap-4">
        <a href="/tutordashboard"
            class=" mb-2 flex items-center  {{ request()->is('tutordashboard') ? 'bg-yellow-300 border-yellow-600 border-2 scale-105 translate-x-4 shadow-lg' : '' }} gap-3 px-4 py-2 hover:bg-yellow-300 hover:translate-x-4 hover:shadow-lg rounded-xl">
        ...
        <a href="/tutorschedule"
            class=" mb-2 flex items-center  {{ request()->is('tutorschedule') ? 'bg-yellow-300 border-yellow-600 border-2 scale-105 translate-x-4 shadow-lg' : '' }} gap-3 px-4 py-2 hover:bg-yellow-300 hover:translate-x-4 hover:shadow-lg rounded-xl">
            <img src="{{ ('images/calendar.png') }}" class=" w-7 h-7" alt="Schedule" />
            <span class="text-black text-base hidden md:block">Schedule</span>
        </a>
        <a href="/tutorpayment"
            class=" mb-2 flex items-center  {{ request()->is('tutorpayment') ? 'bg-yellow-300 border-yellow-600 border-2 scale-105 translate-x-4 shadow-lg' : '' }} gap-3 px-4 py-2 hover:bg-yellow-300 hover:translate-x-4 hover:shadow-lg rounded-xl">
            <img src="{{ ('images/cash-payment.png') }}" class=" w-7 h-7" alt="Payment" />
            <span class="text-black text-base hidden md:block">Payment</span>
        </a>

        <a href="/tutorprofile"
            class=" mb-2 flex items-center  {{ request()->is('tutorprofile') ? 'bg-yellow-300 border-yellow-600 border-2 scale-105 translate-x-4 shadow-lg' : '' }} gap-3 px-4 py-2 hover:bg-yellow-300 hover:translate-x-4 hover:shadow-lg rounded-xl">
