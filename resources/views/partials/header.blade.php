    ...
    <div class="container mx-auto flex justify-between w-full">
        ...
        <div class="flex items-center gap-3">
            <button onclick="toggleDarkMode()"
                class="flex items-center space-x-2 px-3 py-3 bg-white/10 text-white rounded-md">
            ...
            <div class="relative inline-block text-left">
                <div>
                    <button type="button"
                        class="inline-flex w-full justify-center gap-x-3 items-center rounded-md px-3 py-2 text-sm font-semibold text-white hover:bg-white/10"
                ...
                <div class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dropdown-menu-profile hidden"
