            ...
            <div class="flex justify-center gap-4">
                    ...
                    <div class="w-96">
                        <div class="flex flex-col gap-4 p-4 bg-yellow-50 rounded-2xl">
                            ...
                            <div class="bg-orange-400 px-5 py-2 rounded-lg">
                                <small><strong>Penting</strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex
                                    delectus rem dolore ipsam sed sapiente doloribus officiis quibusdam incidunt
                                    illum.</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-96 flex flex-col gap-3">
                    ...
                    <form action="{{ 'parentspayment' }}" method="POST">
                        <div class="flex flex-col gap-3 bg-yellow-50 p-4 rounded-2xl">
                            <div
                                class="relative w-full h-36 rounded-2xl overflow-hidden bg-gray-200 flex items-center justify-center cursor-pointer">
                                ...
                                <span id="file-name" class="opacity-0 absolute">Choose File</span>
                            </div>
                            ...
                            <div class="flex flex-col">
                                ...
                                <input class="border border-black py-1 px-2 rounded-lg"type="text" name=""
                                    id="">
                            </div>
                            <div class="flex flex-col">
                            ...
                            <button type="submit"
                                class="bg-orange-500 py-2 rounded-2xl text-white font-semibold">Konfirmasi
                                Pembayaran</button>
                    </form>
    ...
    <script>
        document.getElementById('file-upload').addEventListener('change', function() {
            if (this.files && this.files[0]) {
                ...
                fileNameElement.classList.add('text-black-500'); // Tambahkan kelas untuk membuat teks terlihat
