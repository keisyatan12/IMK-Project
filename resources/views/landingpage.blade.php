...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    <nav class="bg-[#001840] mx-auto w-full py-4 px-8">
        <div class="container mx-auto flex justify-between items-center w-full">
            ...
            <div class="lg:hidden">
                <button id="nav-toggle" class="flex items-center p-1 text-white hover:text-yellow-500 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            ...
            <ul id="nav-content" class="lg:flex lg:items-center lg:space-x-6 list-reset flex-1 items-center">
                <li class="ml-52">
                    <a class="inline-block py-2 px-4 text-white font-bold no-underline hover:text-yellow-500" href="#">Beranda</a>
                </li>
                <li class="mr-3">
                    <a class="inline-block text-white font-bold no-underline hover:text-yellow-500 py-2 px-4" href="#">Tentang Kami</a>
                </li>
                <li class="ml-64">
                    <a class="inline-block text-white font-bold no-underline hover:text-yellow-500 py-2 px-4" href="#">Kontak</a>
                </li>
                <li class="flex items-center space-x-2 absolute right-96">
                    <button onclick="toggleDarkMode()" class="flex items-center px-3 py-3 bg-white/10 text-white rounded-md">
                        <img src="{{ ('images/moon.svg') }}" alt="moon" class="w-6"/>
                    </button>
                </li>
                @if (Route::has('login'))
                <li>
                    <div class="text-right z-10 ml-28">
                        @auth
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="hover:underline bg-white text-blue-900 font-bold rounded-full py-2 px-8">Register</a>
                            @endif
                       @endauth
                    </div>
                </li>
